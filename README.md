...
An attempt to match my [personal mappings](https://ke-complex-modifications.pqrs.org/?q=jeebak) for [Karabiner-Elements](https://pqrs.org/osx/karabiner/) under macOS, for Windows.
...
- For Linux: [touchcursor-x11](https://github.com/jeebak/touchcursor-x11) (archived; currently working on a port to [keyd](https://github.com/rvaiya/keyd))
